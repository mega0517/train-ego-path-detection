...
그림 3은 한 이벤트에서 세 방법의 거동을 비교한 것이다. (b)에서 분기기 통과 이전에는 세 방법 모두 흔들림이 1–2 px로 낮게 유지되다가, 불확실 구간에 들어서면서 급격히 상승한다. 최대치는 base가 약 76 px인 반면 EMA는 약 32 px로 절반 이하이며, 학습형 정련(rnn)의 곡선은 base와 거의 구분되지 않는다 — 6.3절에서 지적한 항등 수렴이 개별 이벤트 수준에서도 관찰된다.

![그림 3. 정성 비교. (a) 불확실 구간의 한 프레임에 세 방법의 예측을 겹쳐 그린 것. (b) 이벤트 전체에 걸친 프레임 간 흔들림. 음영은 불확실 구간, 세로 실선은 분기기 통과 시각, 점선은 (a)의 프레임 위치다.](figures/fig_qualitative.png)

**그림 3.** 정성 비교 — (a) 불확실 구간의 한 프레임, (b) 프레임 간 흔들림의 시간 변화
